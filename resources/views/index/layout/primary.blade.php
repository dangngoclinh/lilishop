    ...
    <div class="container clearfix">
        ...
        <nav id="main-menu">
            ...
            {{--<ul id="menu-main-menu" class="menu">
                ...
                <li class="menu-item-megamenu-parent megamenu-4-columns-group menu-item-depth-0 steelblue"><a
                            href="#" title=""> Pages </a>
                                    ...
                                    <ul>
                                        <li class="widget widget_popular_products">
                                            <ul class="product_list_widget">
                                                <li>
                                                    <a href="#" title="">
                                                        <img src="http://placehold.it/70x70" alt="product">
                                        ...
                                        <li class="widget widget_recent_entries">
                                            <div class="entry-thumb">
                                                <a href="blog-detail.html"><img
                                                            src="http://placehold.it/200x137" alt=""
                                                            title=""></a>
                                            </div>
                ...
                <li class="menu-item-simple-parent menu-item-depth-0 lavender"><a href="blog.html"
                                                                                  title="">Blog</a>
                    <ul class="sub-menu">
        ...
        <ul class="dt-sc-social-icons">
            <li><a href="{{ option('facebook') }}" title="Facebook" class="dt-sc-tooltip-top facebook"><span
                            class="fa fa-facebook"></span></a></li>
            <li><a href="{{ option('youtube') }}" title="Youtube" class="dt-sc-tooltip-top youtube"><span
                            class="fa fa-youtube"></span></a></li>
            <li><a href="{{ option('twitter') }}" title="Twitter" class="dt-sc-tooltip-top twitter"><span
                            class="fa fa-twitter"></span></a></li>
            <li><a href="{{ option('google') }}" title="Google Plus" class="dt-sc-tooltip-top gplus"><span
