...
@endsection
@section('content')
    <form class="form-horizontal" method="post" action="{{ action('Admin\RoleController@update') }}">
        {{ csrf_field() }}
        @include('adminlte.layout.partials.error')
        <div class="box box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">@lang('Update Role')</h3>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="slug" placeholder="@lang('Slug')" value="{{ $role->slug }}">
                    </div>
                </div>
            </div>
            <!-- End .box-body -->
            <div class="box-footer">
                ...
                <button type="submit" class="btn btn-info pull-right">@lang('Update')</button>
            </div>
            <!-- .box-footer -->
        </div>
        <!-- /.box -->
